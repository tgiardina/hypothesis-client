...
import NotebookResults from '../notebook-results';
import { $imports } from '../notebook-results';
...
describe('NotebookResults', () => {
  ...
  context('when there are no results', () => {
    it('should show "No Results" if no filters are applied', () => {
      ...
      fakeUseRootThread.returns({ totalChildren: 0 });
